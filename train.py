...
zh_vocab_file_path = "/content/mytransformer/zh_vocab.pkl"
en_vocab_file_path = "/content/mytransformer/en_vocab.pkl"
...
src_file = '/content/mytransformer/data/chinese.zh/chinese.zh'
trg_file = '/content/mytransformer/data/english.en/english.en'
